...
export class InsertSubMenuCatalogCategories1594218405995 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        VALUES ('Categories', (SELECT id FROM (SELECT id FROM OrderManagement.m_menu where url = '/catalog') as Y),
        '/catalog/categories', NOW(), NOW(), 1, 1, 1, NULL,1,
